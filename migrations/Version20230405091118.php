 ...
 */
final class Version20230405091118 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE quote (id INT AUTO_INCREMENT NOT NULL, episode_id INT DEFAULT NULL, personage_id INT DEFAULT NULL, user_id INT DEFAULT NULL, text LONGTEXT NOT NULL, rating SMALLINT DEFAULT NULL, validated TINYINT(1) NOT NULL, INDEX IDX_6B71CBF4362B62A0 (episode_id), INDEX IDX_6B71CBF4EA8E3E4A (personage_id), INDEX IDX_6B71CBF4A76ED395 (user_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE season (id INT AUTO_INCREMENT NOT NULL, title VARCHAR(128) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
