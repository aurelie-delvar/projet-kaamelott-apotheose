...
C'est une femme irascible qui hait son mari le Roi Loth et encore plus Arthur, son demi-frère qu'elle considère comme un usurpateur et un bâtard.",2),
...
(8,"Capito", NULL, NULL, "Publius Servius Capito est un sénateur romain et bras droit de Lucius Sillius Sallustius. Il apparaît pour la première fois dans le Livre IV lors de la jeune d’Arthur à Rome. Impulsif et menaçant, il est souvent utilisé par Sallustius pour mettre la pression sur d’autres sénateurs ou effectuer des tâches secondaires.", 8),
...
C'est une femme aigrie et froide qui déteste Arthur et n'hésite pas à lui dire à chaque fois qu'elle a l'occasion de le voir.", 10),
...
Elle réapparait dans Kaamelott : Premier Volet et semble s'être acclimatée à sa vie terrestre et insiste pour qu'Arthur retire à nouveau l'épée du rocher.", 12),
...
(15,"Edern", NULL, NULL, "Edern apparait dans l'épisode pilote n°6 de Kaamelott, intitulé 'Le Chevalier Femme' : il s'agit de la fille d'un ami de Léodagan et la seule femme chevalier de la Table Ronde.", 15),
...
Il apparait pour la première fois dans l'épisode Miles Ignotus du livre VI.", 25),
(26,"Séfriane d'Aquitaine", NULL, NULL, "Séfriane d'Aquitaine est la nièce du Duc d'Aquitaine.
Elle n'apparait que lors d'un seul épisode (Séfriane d'Aquitaine, Livre III), lors duquel elle assiste une la réunion de la Table Ronde avec Bohort, Léodagan et Arthur au sujet de l'achat de béliers pour le royaume.", 26),
...
Il ne parle pas la langue d'Arthur et balbutie parfois quelques mots sans en comprendre leur signification ce qui génère de nombreux quiproquos.", 33),
...
Dans Kaamelott : Premier Volet, il est toujours membre du clan des Semi-Croustillants, et est nommé colonel à titre aromatique par Karadoc pour le féliciter.", 41),
...
Il deviendra un temps régent de Bretagne suite à une manipulation de Mevanwi qui détruisit l’acte d’annulation de l’échange d’épouses.", 42),
...
Il apparait également dans la scène post-générique de Kaamelott : Premier Volet, où on le voit ramper sur le sol, ramasser de la neige et la boire et se retourner, allongé face au ciel.", 47),
...
Ils creusent des tunnels avec leur clan pour contrer Lancelot, devenu roi, et cela leur permet de libérer Arthur lorsqu'il est fait prisonnier et également de faire s'écrouler une partie du chateau.", 49),
...
(52,"Le Tavernier", NULL, NULL, "Le tavernier est le propriétaire d'une taverne aux alentours de Kaamelott dans laquelle se retrouve plusieurs fois par jour Karadoc et Perceval. Au fil du temps, il se lie d'amitié avec les deux chevaliers, jouant même à l'occasion à des jeux de société avec eux à la fin de son service : Le cul de chouette, Le Contre-sirop, Chante sloubi... Au cours du livre V, il accepte que sa taverne devienne le quartier général du nouveau clan autonome monté par Perceval et Karadoc.", 52),
(53,"Urgan", NULL, NULL, NULL, 53),
(54,"Venec", NULL, NULL, NULL, 54),
(55,"Yvain", NULL, NULL, NULL, 55),
(56,"Tumet (Les Jumelles du pêcheur)", NULL, NULL, "Aziliz et Tumet sont des jumelles, filles d'un pêcheur (ce qui leur vaut le surnom des Jumelles du pêcheur) et qui sont les maitresses du Roi Arthur Pendragon. Arthur les a rencontré à son arrivée en Bretagne après avoir passé son adolescence à Rome. Elles ont chacune un caractère différent : Azilis est vive et impulsive et s'énerve facilement, tandis que Tumet est plus douce et calme.", 21); 